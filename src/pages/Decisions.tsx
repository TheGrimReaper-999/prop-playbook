...
import { ArrowLeft, TrendingUp, TrendingDown, MinusCircle, Receipt, Check, Layers, ChevronDown, ChevronUp, BarChart3, Loader2, AlertCircle, Zap, Calendar, LogIn } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Sign in to access betting analysis</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <Card className="bg-card/50 border-border/50">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Create an account or sign in to access betting decisions and analysis
              </p>
